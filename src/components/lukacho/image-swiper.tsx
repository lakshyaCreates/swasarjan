...
export const ImageSwiper: React.FC<{
    ...
    return (
        <div
            className={cn(
                "group/hover relative aspect-square h-full w-full overflow-hidden rounded-2xl",
                className,
            )}
        >
            <div className="pointer-events-none absolute top-1/2 z-10 flex w-full -translate-y-1/2 justify-between px-5">
                ...
                >
                    <ArrowLeftIcon className="stroke-neutral-600" size={20} />
                </button>
                <button
                ...
                >
                    <ArrowRightIcon className="stroke-neutral-600" size={20} />
                </button>
            </div>
